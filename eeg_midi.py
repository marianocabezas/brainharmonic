...
class Track(object):
    ...
    def add_note(self, note, time, length, velocity, pitch=0):
...
class Note(object):
    def __init__(self, note, time, tickspeed, length=1, velocity=64, pitch=0):
